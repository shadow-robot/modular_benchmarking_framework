...
#ifndef MODULAR_FRAMEWORK_CORE_JOINT_TRAJECTORY_MANAGER_H
#define MODULAR_FRAMEWORK_CORE_JOINT_TRAJECTORY_MANAGER_H

#include <ros/ros.h>
#include <modular_framework_core/AddJointTrajectory.h>
#include <modular_framework_core/GetJointTrajectory.h>
#include <modular_framework_core/GetJointState.h>
...
class JointTrajectoryManager
{
  ...
  private:
    ...
    bool _add_trajectory(modular_framework_core::AddJointTrajectoryRequest& request,
                         modular_framework_core::AddJointTrajectoryResponse& response);
    bool _get_trajectory(modular_framework_core::GetJointTrajectoryRequest& request,
                         modular_framework_core::GetJointTrajectoryResponse& response);
};

#endif  // MODULAR_FRAMEWORK_CORE_JOINT_TRAJECTORY_MANAGER_H
