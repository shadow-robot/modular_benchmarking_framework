...
#ifndef MODULAR_FRAMEWORK_CORE_ACM_MANAGER_H
#define MODULAR_FRAMEWORK_CORE_ACM_MANAGER_H

#include <ros/ros.h>
#include <modular_framework_core/SetInitACM.h>
#include <modular_framework_core/UpdateACMEntry.h>
#include <modular_framework_core/GetModifiedACM.h>
...
class ACMManager
{
  ...
  private:
    ...
    bool _set_init_acm(modular_framework_core::SetInitACMRequest& request,
                       modular_framework_core::SetInitACMResponse& response);
    bool _update_acm_entry(modular_framework_core::UpdateACMEntryRequest& request,
                           modular_framework_core::UpdateACMEntryResponse& response);
    bool _get_modified_acm(modular_framework_core::GetModifiedACMRequest& request,
                           modular_framework_core::GetModifiedACMResponse& response);
};

#endif  // MODULAR_FRAMEWORK_CORE_ACM_MANAGER_H
