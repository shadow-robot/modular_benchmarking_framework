...
#ifndef MODULAR_FRAMEWORK_CORE_JOINT_STATE_MANAGER_H
#define MODULAR_FRAMEWORK_CORE_JOINT_STATE_MANAGER_H

#include <ros/ros.h>
#include <modular_framework_core/AddJointState.h>
...
class JointStateManager
{
  ...
  private:
    ...
    bool _add_joint_state(modular_framework_core::AddJointStateRequest& request,
                          modular_framework_core::AddJointStateResponse& response);
    bool _get_joint_state(modular_framework_core::GetJointStateRequest& request,
                          modular_framework_core::GetJointStateResponse& response);
};

#endif  // MODULAR_FRAMEWORK_CORE_JOINT_STATE_MANAGER_H
