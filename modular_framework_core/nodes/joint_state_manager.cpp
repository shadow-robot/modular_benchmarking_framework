 ...
 */
bool JointStateManager::_add_joint_state(modular_framework_core::AddJointStateRequest& request,
 ...
 * @return          Boolean that should be always true in order to avoid having runtime errors on the client side
 */
bool JointStateManager::_get_joint_state(modular_framework_core::GetJointStateRequest& request,
