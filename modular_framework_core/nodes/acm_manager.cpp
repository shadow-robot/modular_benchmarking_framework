 ...
 */
bool ACMManager::_set_init_acm(modular_framework_core::SetInitACMRequest& request,
 ...
 * @return          Boolean that should be always true in order to avoid having runtime errors on the client side
 */
bool ACMManager::_update_acm_entry(modular_framework_core::UpdateACMEntryRequest& request,
 ...
 * @return          Boolean that should be always true in order to avoid having runtime errors on the client side
 */
bool ACMManager::_get_modified_acm(modular_framework_core::GetModifiedACMRequest& request,
