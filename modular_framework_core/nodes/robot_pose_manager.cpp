...
#include <modular_framework_core/robot_pose_manager.hpp>
#include <string>
...
void RobotPoseManager::load_robot_poses_from_file(std::string file_path)
{
    ...
    for (YAML::const_iterator robot_pose = robot_poses.begin(); robot_pose != robot_poses.end(); ++robot_pose)
    {
        ...
        if (!robot_pose->second["position"])
        {
            ...
            modular_framework_core::RobotPose robot_pose_msg;
 ...
 */
bool RobotPoseManager::_add_robot_pose(modular_framework_core::AddRobotPoseRequest& request,
                                       modular_framework_core::AddRobotPoseResponse& response)
{
    ...
    modular_framework_core::RobotPose robot_pose = request.robot_pose;
 ...
 * @return          Boolean that should be always true in order to avoid having runtime errors on the client side
 */
bool RobotPoseManager::_get_robot_pose(modular_framework_core::GetRobotPoseRequest& request,
