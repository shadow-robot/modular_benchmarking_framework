...
void JointTrajectoryManager::load_trajectories_from_file(std::string file_path)
{
    ...
    ros::ServiceClient get_joint_state =
        node_handler_.serviceClient<modular_framework_core::GetJointState>("get_joint_state");
    // Initialise the interface
    modular_framework_core::GetJointState service;
 ...
 */
bool JointTrajectoryManager::_add_trajectory(modular_framework_core::AddJointTrajectoryRequest& request,
 ...
 * @return          Boolean that should be always true in order to avoid having runtime errors on the client side
 */
bool JointTrajectoryManager::_get_trajectory(modular_framework_core::GetJointTrajectoryRequest& request,
