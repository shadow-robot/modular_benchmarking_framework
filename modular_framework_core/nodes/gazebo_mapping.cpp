...
#include <modular_framework_core/gazebo_mapping.hpp>
#include <string>
 ...
 */
bool GazeboMappingManager::_add_gazebo_mapping(modular_framework_core::AddGazeboMappingRequest& request,
 ...
 * @return          Boolean that should be always true in order to avoid having runtime errors on the client side
 */
bool GazeboMappingManager::_get_object_type(modular_framework_core::GetGazeboTypeRequest& request,
...
bool GazeboMappingManager::_delete_gazebo_mapping(
    modular_framework_core::DeleteGazeboMappingRequest& request,
