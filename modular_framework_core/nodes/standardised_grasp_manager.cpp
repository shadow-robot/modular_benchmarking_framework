 ...
 */
bool StandardisedGraspManager::_add_grasp(modular_framework_core::AddStandardisedGraspRequest& request,
                                          modular_framework_core::AddStandardisedGraspResponse& response)
{
    ...
    modular_framework_core::StandardisedGrasp grasp_message = request.grasp_message;
 ...
 * @return          Boolean that should be always true in order to avoid having runtime errors on the client side
 */
bool StandardisedGraspManager::_get_grasp(modular_framework_core::GetStandardisedGraspRequest& request,
