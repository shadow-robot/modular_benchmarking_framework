 ...
 */
bool MoveitPlanManager::_add_plan(modular_framework_core::AddMoveitPlanRequest& request,
 ...
 * @return          Boolean that should be always true in order to avoid having runtime errors on the client side
 */
bool MoveitPlanManager::_get_plan(modular_framework_core::GetMoveitPlanRequest& request,
