...
from PyQt5.QtWidgets import (QWidget, QGridLayout, QLabel, QLineEdit,
                             QToolButton, QFileDialog, QSpinBox, QHBoxLayout, QCheckBox)
...
class SimulationConfig(GenericInterfaceConfigWidget):
    ...
    def initialize_content(self):
        ...
        self.layout.addWidget(self.check_box, self.current_row, 0)
        self.current_row += 1
        self.add_user_entry("Gazebo world file")
        self.add_user_entry("Gazebo model folder")
        self.add_user_entry("Starting pose", should_browse=False,
                            placeholder_text="-J shoulder_pan_joint 0.5 -J shoulder_lift_joint 1.5 -J ...")
...
class MoveitConfig(GenericInterfaceConfigWidget):
    ...
    def initialize_content(self):
        ...
        """
        self.add_user_entry("Moveit package")
        self.add_xml_editor("Move group arguments (optional)", enabled=False)
...
class RobotInterfaceConfig(GenericInterfaceConfigWidget):
    ...
    def initialize_content(self):
        ...
        """
        self.add_user_entry("Robot's URDF file")
        self.add_user_entry("URDF arguments (optional)", should_browse=False)
        self.add_user_entry("Custom launch file")
        self.add_xml_editor("Launch file arguments (optional)")
        self.add_user_entry("Collision scene", enabled=False)
    ...
    def add_robot_composition(self):
        ...
        self.layout.addLayout(horizontal_layout, self.current_row, 0, 1, 3)
        self.current_row += 1
